...
```
Установить клиент letsencrypt. На сайте <https://certbot.eff.org/> можно выбрать операционную систему сервера и ПО веб-сервера, для которых будет отображена инструкция по установке.
```bash
